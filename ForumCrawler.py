...
class ForumcrawlerSpider(CrawlSpider):
    name = 'ForumCrawler'
    allowed_domains = ['gardenstew.com'] # sixcrazyminutes.com, gardenstew.com,  co.uk
    start_urls = ['https://www.gardenstew.com/'] # http://sixcrazyminutes.com/forums/, https://www.gardenstew.com/, https://ukofequestria.co.uk/
